<?php
    ...
    require_once '../ab_core/aa_init.php';
     $response               = array();
      ...
      $return_obj= ac_DB::getInstance()->query("SELECT id,organization,price,category,details,userid,image,mobno,place,contacts,approval,avgRating FROM aa_seedform",array());
